...
@Component
class WithdrawTransactionProcessor (
    ...
    private fun validate(createTransactionCommand: CreateTransactionCommand) {
        if (createTransactionCommand.sender == null) {
            throw RuntimeException("For withdraw transaction sender should not be null")
        }
        if (createTransactionCommand.recipient != null) {
            throw RuntimeException("For withdraw transaction recipient should be null")
        }
    }
}
